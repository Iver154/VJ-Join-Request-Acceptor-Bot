...
async def start_message(c,m):
    ...
    await m.reply_photo(f"https://te.legra.ph/file/119729ea3cdce4fefb6a1.jpg",
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
                InlineKeyboardButton('💝 ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/+ffiLKas6O8o0MWI1')
            ],[
                InlineKeyboardButton("❣️ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ", url='https://t.me/+IZfEBz_yY-ZlMDM1'),
                InlineKeyboardButton("🤖 ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ 2", url='https://t.me/+SRkSYn3lUP9lYTIx')
            ]]
        )
    )
...
async def approve_new(client, m):
    ...
    try:
        ...
        try:
            await client.send_message(m.from_user.id, "**Hello {}!\nWelcome To {}\n\n__Powered By : @whitewalkerv5_bot**".format(m.from_user.mention, m.chat.title))
        except:
            pass
    except Exception as e:
        print(str(e))
